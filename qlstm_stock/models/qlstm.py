"""Quantum LSTM (QLSTM) regressor, ported from the original Factory.py.

The variational quantum circuit design is unchanged from the original
implementation (itself adapted from https://github.com/rdisipio/qlstm);
only the surrounding module layout has changed.
"""
...
class QShallowRegressionLSTM(SequenceRegressor):
